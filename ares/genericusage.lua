...
module( "genericusage", package.seeall )
...
function CourierUsageThink()
	...
	local burst=courier:GetAbilityByName("courier_burst")   -- This will be replaced by covering
	...
	if(state == COURIER_STATE_IDLE)		-- Back home when idle last 10 seconds
	then
